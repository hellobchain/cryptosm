...
import _ "github.com/wsw365904/cryptosm/tls"
func main() {}
`,
			bad: []string{
				"tls.(*Conn)",
		...
		},
		{
			...
			program: `package main
import "github.com/wsw365904/cryptosm/tls"
func main() {
  tls.Dial("", "", nil)
  tls.Server(nil, nil)
}
`,
			want: []string{
				"github.com/wsw365904/cryptosm/tls.(*Conn).clientHandshake",
				"github.com/wsw365904/cryptosm/tls.(*Conn).serverHandshake",
			},
		},
		{
			name: "only_client",
