...
func (e *gfP2) Conjugate(a *gfP2) *gfP2 { //xi+y-->-xi+y
	e.y.Set(&a.y)
	gfpNeg(&e.x, &a.x)
	return e
}
...
// http://eprint.iacr.org/2006/471.pdf
func (e *gfP2) Mul1(a, b *gfP2) *gfP2 {
	tx, t := &gfP{}, &gfP{}
	gfpMul(tx, &a.x, &b.y)
	gfpMul(t, &b.x, &a.y)
	gfpAdd(tx, tx, t)
...
func (e *gfP2) Mul(a, b *gfP2) *gfP2 { //lazy reduction:4mul-->3mul
	//tx, t := &gfP{}, &gfP{}
	t0, t1, t2, t3 := &gfP{}, &gfP{}, &gfP{}, &gfP{}
...
func (e *gfP2) Square(a *gfP2) *gfP2 {
	...
	//SM9: (xi+y)² = y^2-2*x^2 + 2*i*x*y
	tx, ty := &gfP{}, &gfP{}
	gfpSub(tx, &a.y, &a.x)
	gfpAdd(ty, &a.x, &a.y)
	gfpMul(ty, tx, ty)
	gfpMul(tx, &a.x, &a.x)
	gfpSub(ty, ty, tx) //y^2-2*x^2 = (x+y)(y-x)-x^2
