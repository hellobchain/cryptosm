...
import (
	...
	"github.com/wsw365904/cryptosm/x509/pkix"
	"io"
	"math/big"
	"net"
	"net/url"
	...
	// Explicitly import these for their cryptosm.RegisterHash init side-effects.
...
func marshalPublicKey(pub interface{}) (publicKeyBytes []byte, publicKeyAlgorithm pkix.AlgorithmIdentifier, err error) {
	...
	case *ecdsa.PublicKey:
		...
		publicKeyAlgorithm.Algorithm = getOidPublicKeyAlgFromNamedCurve(pub.Curve)
		var paramBytes []byte
...
var signatureAlgorithmDetails = []struct {
	...
	{MD2WithRSA, "MD2-RSA", oidSignatureMD2WithRSA, RSA, cryptosm.Hash(0) /* no value for MD2 */},
	{MD5WithRSA, "MD5-RSA", oidSignatureMD5WithRSA, RSA, cryptosm.MD5},
	{SHA1WithRSA, "SHA1-RSA", oidSignatureSHA1WithRSA, RSA, cryptosm.SHA1},
	{SHA1WithRSA, "SHA1-RSA", oidISOSignatureSHA1WithRSA, RSA, cryptosm.SHA1},
	{SHA256WithRSA, "SHA256-RSA", oidSignatureSHA256WithRSA, RSA, cryptosm.SHA256},
	{SHA384WithRSA, "SHA384-RSA", oidSignatureSHA384WithRSA, RSA, cryptosm.SHA384},
	{SHA512WithRSA, "SHA512-RSA", oidSignatureSHA512WithRSA, RSA, cryptosm.SHA512},
	{SHA256WithRSAPSS, "SHA256-RSAPSS", oidSignatureRSAPSS, RSA, cryptosm.SHA256},
	{SHA384WithRSAPSS, "SHA384-RSAPSS", oidSignatureRSAPSS, RSA, cryptosm.SHA384},
	{SHA512WithRSAPSS, "SHA512-RSAPSS", oidSignatureRSAPSS, RSA, cryptosm.SHA512},
	{DSAWithSHA1, "DSA-SHA1", oidSignatureDSAWithSHA1, DSA, cryptosm.SHA1},
	{DSAWithSHA256, "DSA-SHA256", oidSignatureDSAWithSHA256, DSA, cryptosm.SHA256},
	{ECDSAWithSHA1, "ECDSA-SHA1", oidSignatureECDSAWithSHA1, ECDSA, cryptosm.SHA1},
	{ECDSAWithSHA256, "ECDSA-SHA256", oidSignatureECDSAWithSHA256, ECDSA, cryptosm.SHA256},
	{ECDSAWithSHA384, "ECDSA-SHA384", oidSignatureECDSAWithSHA384, ECDSA, cryptosm.SHA384},
	{ECDSAWithSHA512, "ECDSA-SHA512", oidSignatureECDSAWithSHA512, ECDSA, cryptosm.SHA512},
	{PureEd25519, "Ed25519", oidSignatureEd25519, Ed25519, cryptosm.Hash(0) /* no pre-hashing */},
	{SM2WithSM3, "SM2-SM3", oidSignatureSM2WithSM3, SM2, cryptosm.SM3},
	{SM2WithSHA1, "SM2-SHA1", oidSignatureSM2WithSHA1, SM2, cryptosm.SHA1},
	{SM2WithSHA256, "SM2-SHA256", oidSignatureSM2WithSHA256, SM2, cryptosm.SHA256},
}
...
var hashToPSSParameters = map[cryptosm.Hash]asn1.RawValue{
	cryptosm.SHA256: asn1.RawValue{FullBytes: []byte{48, 52, 160, 15, 48, 13, 6, 9, 96, 134, 72, 1, 101, 3, 4, 2, 1, 5, 0, 161, 28, 48, 26, 6, 9, 42, 134, 72, 134, 247, 13, 1, 1, 8, 48, 13, 6, 9, 96, 134, 72, 1, 101, 3, 4, 2, 1, 5, 0, 162, 3, 2, 1, 32}},
	cryptosm.SHA384: asn1.RawValue{FullBytes: []byte{48, 52, 160, 15, 48, 13, 6, 9, 96, 134, 72, 1, 101, 3, 4, 2, 2, 5, 0, 161, 28, 48, 26, 6, 9, 42, 134, 72, 134, 247, 13, 1, 1, 8, 48, 13, 6, 9, 96, 134, 72, 1, 101, 3, 4, 2, 2, 5, 0, 162, 3, 2, 1, 48}},
	cryptosm.SHA512: asn1.RawValue{FullBytes: []byte{48, 52, 160, 15, 48, 13, 6, 9, 96, 134, 72, 1, 101, 3, 4, 2, 3, 5, 0, 161, 28, 48, 26, 6, 9, 42, 134, 72, 134, 247, 13, 1, 1, 8, 48, 13, 6, 9, 96, 134, 72, 1, 101, 3, 4, 2, 3, 5, 0, 162, 3, 2, 1, 64}},
}
...
var (
	...
	oidPublicKeySM2     = asn1.ObjectIdentifier{1, 2, 156, 197, 1, 301} // wsw add
...
func getOidPublicKeyAlgFromNamedCurve(curve elliptic.Curve) asn1.ObjectIdentifier {
	switch curve {
	case elliptic.P224():
...
// signature algorithm.
func signingParamsForPublicKey(pub interface{}, requestedSigAlgo SignatureAlgorithm) (hashFunc cryptosm.Hash, sigAlgo pkix.AlgorithmIdentifier, err error) {
	var pubType PublicKeyAlgorithm

	switch pub := pub.(type) {
	case *rsa.PublicKey:
		pubType = RSA
		hashFunc = cryptosm.SHA256
...
// cryptosm.Signer with a supported public key.
//
...
func CreateCertificate(rand io.Reader, template, parent *Certificate, pub, priv interface{}) ([]byte, error) {
	...
	if !ok {
		return nil, errors.New("x509: certificate private key does not implement cryptosm.Signer")
	}
	...
	var signerOpts crypto.SignerOpts = crypto.Hash(hashFunc)
	...
	// Check the signature to ensure the cryptosm.Signer behaved correctly.
...
func (c *Certificate) CreateCRL(rand io.Reader, priv interface{}, revokedCerts []pkix.RevokedCertificate, now, expiry time.Time) (crlBytes []byte, err error) {
	...
	var signature []byte
	signature, err = key.Sign(rand, signed, crypto.Hash(hashFunc))
	if err != nil {
		return
	}
...
// key will be included in the CSR. It must implement cryptosm.Signer and its
